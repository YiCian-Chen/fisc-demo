...
('cc874d79-a3b3-4016-8cc3-327309473503', '櫃員', '行庫櫃台人員(登打)', '{"folder.system":[],"system.users":["q","m"],"system.roles": ["q","m"],"folder.fisc":[],"fisc.notice":["x"]}'),
('288dcdbd-261c-44ee-a669-37d8a8e455b9', '主管', '行庫主管(放行)', '{"folder.system":[],"system.users":["q","m"],"system.roles": ["q","m"],"system.permissions":["q","m"]}');
